...
package Languages is
   ...
   package Key_Vectors is new Ada.Containers.Vectors (Index_Type => Positive, Element_Type => Qweyboard.Softkey);
   package Layer_Maps is new Ada.Containers.Ordered_Maps (Key_Type => Qweyboard.Softkey, Element_Type => Wide_Wide_Character);
   package Layout_Maps is new Ada.Containers.Ordered_Maps (Key_Type => Qweyboard.Softkey, Element_Type => Layer_Maps.Map, "=" => Layer_Maps."=");
   ...
   protected User_Language is
      ...
      procedure Add_Key (Modifier : Qweyboard.Softkey; Key : Qweyboard.Softkey; Symbol : Wide_Wide_Character);
   ...
   private
      ...
      function Mod_Layer (Layout : Layout_Type; Modifier : Qweyboard.Softkey; Pressed : Key_Sets.Set) return Layer_Maps.Map;
